...
import type {
  ...
  IDataLayrPaymentManagerInterface,
} from "../../../../../contracts/libraries/eigenda/interfaces/IDataLayrPaymentManager";
...
export class IDataLayrPaymentManager__factory {
  ...
  static createInterface(): IDataLayrPaymentManagerInterface {
    return new utils.Interface(_abi) as IDataLayrPaymentManagerInterface;
  }
  static connect(
    address: string,
