...
import type {
  DelegationSlasher,
  DelegationSlasherInterface,
} from "../../../../contracts/L1/delegation/DelegationSlasher";
...
export class DelegationSlasher__factory {
  static readonly abi = _abi;
  static createInterface(): DelegationSlasherInterface {
    return new utils.Interface(_abi) as DelegationSlasherInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DelegationSlasher {
    return new Contract(address, _abi, signerOrProvider) as DelegationSlasher;
  }
}
