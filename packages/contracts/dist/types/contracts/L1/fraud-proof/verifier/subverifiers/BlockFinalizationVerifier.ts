...
export declare namespace OneStepProof {
  export type BlockStateProofStruct = {
  ...
  export type BlockStateProofStructOutput = [
    BigNumber,
    string,
    BigNumber,
    string
...
export interface BlockFinalizationVerifierInterface extends utils.Interface {
  functions: {
...
export interface BlockFinalizationVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BlockFinalizationVerifierInterface;
  ...
  functions: {
    executeOneStepProof(
      ...
      [OneStepProof.BlockStateProofStructOutput] & {
        endState: OneStepProof.BlockStateProofStructOutput;
      }
    >;
  ...
  executeOneStepProof(
    ...
    encoded: PromiseOrValue<BytesLike>,
    overrides?: CallOverrides
  ): Promise<OneStepProof.BlockStateProofStructOutput>;
