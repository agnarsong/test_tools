...
export interface InvalidOpVerifierInterface extends utils.Interface {
  functions: {
...
export interface InvalidOpVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InvalidOpVerifierInterface;
  ...
  functions: {
    executeOneStepProof(
      ...
      [OneStepProof.StateProofStructOutput] & {
        endState: OneStepProof.StateProofStructOutput;
      }
    >;
