...
export interface IDelegationShareInterface extends utils.Interface {
  functions: {
...
export interface IDelegationShare extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IDelegationShareInterface;
