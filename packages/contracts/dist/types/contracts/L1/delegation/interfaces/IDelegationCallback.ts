...
export interface IDelegationCallbackInterface extends utils.Interface {
  functions: {
...
export interface IDelegationCallback extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IDelegationCallbackInterface;
