...
export interface BVM_L2ToL1MessagePasserInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "passMessageToL1" | "sentMessages"
  ): FunctionFragment;
...
export interface BVM_L2ToL1MessagePasser extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BVM_L2ToL1MessagePasserInterface;
