...
export interface BVM_DeployerWhitelistInterface extends utils.Interface {
  functions: {
...
export interface BVM_DeployerWhitelist extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BVM_DeployerWhitelistInterface;
