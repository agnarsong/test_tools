    ...
    constructor() {
        ...
        this.populateTransaction = {
            ...
            withdraw: async (l1Token, l2Token, amount, opts) => {
                ...
                if ((opts === null || opts === void 0 ? void 0 : opts.recipient) === undefined) {
                    return this.l2Bridge.populateTransaction.withdraw((0, utils_1.toAddress)(l2Token), amount, 0, '0x', Object.assign(Object.assign({}, (0, utils_1.omit)((opts === null || opts === void 0 ? void 0 : opts.overrides) || {}, 'value')), { value: 0 }));
                }
                else {
                    return this.l2Bridge.populateTransaction.withdrawTo((0, utils_1.toAddress)(l2Token), (0, utils_1.toAddress)(opts.recipient), amount, 0, '0x', Object.assign(Object.assign({}, (0, utils_1.omit)((opts === null || opts === void 0 ? void 0 : opts.overrides) || {}, 'value')), { value: 0 }));
                }
            },
        };
    }
    ...
    async getDepositsByAddress(address, opts) {
        ...
        return events
            ...
            return {
                ...
                l2Token: contracts_1.predeploys.BVM_ETH,
