...
const connectGasPriceOracle = (provider) => {
    return new ethers_1.Contract(contracts_1.predeploys.BVM_GasPriceOracle, (0, contracts_1.getContractInterface)('BVM_GasPriceOracle'), (0, utils_1.toProvider)(provider));
};
