...
// GetPauseOwner is a free data retrieval call binding the contract method 0x8ec6a68a.
//
// Solidity: function getPauseOwner() view returns(address)
func (_L1CrossDomainMessenger *L1CrossDomainMessengerCaller) GetPauseOwner(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _L1CrossDomainMessenger.contract.Call(opts, &out, "getPauseOwner")
...
//
// Solidity: function getPauseOwner() view returns(address)
func (_L1CrossDomainMessenger *L1CrossDomainMessengerSession) GetPauseOwner() (common.Address, error) {
	return _L1CrossDomainMessenger.Contract.GetPauseOwner(&_L1CrossDomainMessenger.CallOpts)
}

// GetPauseOwner is a free data retrieval call binding the contract method 0x8ec6a68a.
//
// Solidity: function getPauseOwner() view returns(address)
func (_L1CrossDomainMessenger *L1CrossDomainMessengerCallerSession) GetPauseOwner() (common.Address, error) {
	return _L1CrossDomainMessenger.Contract.GetPauseOwner(&_L1CrossDomainMessenger.CallOpts)
}
