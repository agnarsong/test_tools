...
func main() {
	...
	functionName, args, err := parseContractFunctionInputs(abiJSON, inputData)
	if err != nil {
		log.Fatal(err)
	}
...
func parseContractFunctionInputs(abiJSON string, inputData string) (string, map[string]interface{}, error) {
	// 解析 ABI
